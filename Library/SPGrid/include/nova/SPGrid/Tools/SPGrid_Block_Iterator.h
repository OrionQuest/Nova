//!#####################################################################
//! \file SPGrid_Block_Iterator.h
//!#####################################################################
// Classes SPGrid_Block_Iterator/SPGrid_Reverse_Block_Iterator
//######################################################################
#ifndef __SPGrid_Block_Iterator__
#define __SPGrid_Block_Iterator__
...
class SPGrid_Block_Iterator
{
  public:
    ...
    SPGrid_Block_Iterator(const unsigned long* const block_offsets_input,const size_t size_input)
        :block_offsets(block_offsets_input),size(size_input),block_index(0),element_index(0) {}
    
    SPGrid_Block_Iterator(const std::pair<const unsigned long*,size_t>& blocks)
...
class SPGrid_Reverse_Block_Iterator
{
  public:
    ...
    SPGrid_Reverse_Block_Iterator(const unsigned long* const block_offsets_input,const size_t size_input)
        :block_offsets(block_offsets_input),size(size_input),block_index(size-1),element_index(elements_per_block-1) {}

    SPGrid_Reverse_Block_Iterator(const std::pair<const unsigned long*,size_t>& blocks)
